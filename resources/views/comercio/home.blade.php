...
@section('content')
    ...
    <nav class="mb-6 flex gap-1 overflow-x-auto border-b border-gray-200" role="tablist" aria-orientation="horizontal">
        @foreach (['resumen' => 'Resumen', 'menu' => 'Menú', 'ventas' => 'Ventas', 'inventario' => 'Inventario'] as $id => $label)
    ...
    <div id="tab-resumen" role="tabpanel" aria-labelledby="tab-resumen-item">
        ...
        <p class="text-sm text-gray-500">Usa las pestañas para gestionar el menú, revisar tus ventas y registrar compras de inventario. La caja se opera desde el <a href="/pos" target="_blank" class="font-medium text-sky-700 hover:underline">POS</a>.</p>
    </div>
